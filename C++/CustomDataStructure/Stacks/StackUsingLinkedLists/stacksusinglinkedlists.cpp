...
int main(){
    ...
    // ------> [data|pointer] -> [data|pointer] -> [data|pointer] -> [data|pointer] -> NULL
    // All operations are from the left most end so that they are completed in O(1) time
    // and no need to traverse the linked list to reach the end node.
