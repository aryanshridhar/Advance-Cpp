...
Node *reverse(Node *ptr) {
  ...
  // Its highly likely that I will have hard time remembering this next time,
  // hence will be explaining this well.
  ...
  // Till the head points to the last element starting from 2nd element (as
  // written above)/
  while (head != NULL) {
    ...
    prev_node = head;
    // Finally, as mentioned above, change the head value to next value aka
    // next_pointer.
    head = next_pointer;
  }
