...
// Really simple algorithm which mainly works when given elements from 1 to
// natural number n. The algorithm includes positioning each element to it's
// index as it should have been in a sorted order. Or when 1 to n are sorted,
// element = index+1. We apply this basic algorithm to poistion each element to
// its index.
// O(n)
