...
// Works on divide and conquer algorithm, which in this case, works by dividing the array into
// its subvectors from top to bottom and then merging them again one by one from bottom to top.
// 0(nlogn)
